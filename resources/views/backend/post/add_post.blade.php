					...
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								...
								<li class="breadcrumb-item active" aria-current="page">اضافه کردن مقالات</li>
							</ol>
						</nav>
					</div>
        ...
        <div class="card">
            ...
            <div class="card-body p-4">
                ...
                <form  class="row g-3" action="{{ route('store.blog.post') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-md-6">
                        <label for="input7" class="form-label">دستته بندی</label>
                    ...
                    <div class="col-md-6">
                        <label for="input1" class="form-label">موضوع</label>
                        <input type="text" name="post_titile" class="form-control" id="input1"  >
                    </div>


                    <div class="col-md-12">
                        <label for="input11" class="form-label">توضیح مختصر</label>
                    ...
                    <div class="col-md-12">
                        <label for="input11" class="form-label">توضیحات کامل</label>
                        <textarea name="long_descp" class="form-control" id="myeditorinstance" ></textarea>
                    </div>

                    <div class="col-md-6">
                        <label for="input1" class="form-label"> عکس مقاله</label>
