...
<div class="page-content">
				...
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
					<div class="breadcrumb-title pe-3">ویرایش اعضای تیم</div>
					<div class="ps-3">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9 text-secondary">
                        <img id="showImage" src="{{ asset('upload/team/'.$team->image)  }}" alt="Admin" class="rounded-circle p-1 bg-primary" width="80">
                    </div>
                </div>
