...
@section('admin')
    ...
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">رزروها</div>
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        <li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
                        </li>
                        <li class="breadcrumb-item active" aria-current="page">اضافه کردن رزرو</li>
                    </ol>
                </nav>
            </div>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                            <div class="card-body p-4">
                                ...
                                <form method="POST" action="{{ route('admin.booking.store') }}" class="row g-3">
                                    @csrf

                                    <div class="col-md-4">
                                        <label for="roomtype_id" class="form-label">اتاق</label>
                                        <select name="room_id" id="room_id" class="form-select">
                                            <option selected>اتاق را انتخاب کنید</option>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select name="user_id" id="user_id" class="form-select">
                                            <option selected>کاربر را انتخاب کنید</option>
                                    ...
                                    <div class="col-md-4">
                                        <label for="input2" class="form-label">ورود</label>
                                        <input type="date" name="check_in" class="form-control" id="check_in"  >
                                    </div>

                                    <div class="col-md-4">
                                        <label for="input2" class="form-label">خروج</label>
                                    ...
                                    <div class="col-md-4">
                                        <label for="input3" class="form-label">تعداد اتاق</label>
...
{{----}}
                                    ...
                                    <div class="col-md-4">
                                        <label for="input3" class="form-label">تعداد نفرات</label>
...
{{--                                    </div>--}}
                                    ...
                                    <h3 class="mt-3 mb-5 text-center">مشخصات مشتری</h3>

                                    <div class="col-md-4">
                                        <label for="input5" class="form-label">نام</label>
                                        <input type="text" name="name" class="form-control" id="input5" value="{{ old('name') }}"  >
                                    </div>

                                    <div class="col-md-4">
                                        <label for="input5" class="form-label">ایمیل</label>
                                    ...
                                    <div class="col-md-4">
                                        <label for="input5" class="form-label">کشور</label>
                                        <input type="text" name="country" class="form-control" value="{{ old('country') }}"  >
                                    </div>

                                    <div class="col-md-4">
                                        <label for="input5" class="form-label">کد پستی</label>
                                        <input type="text" name="zip_code" class="form-control" value="{{ old('zip_code') }}"  >
                                    </div>

                                    <div class="col-md-4">
                                        <label for="input5" class="form-label">استان</label>
                                    ...
                                    <div class="col-md-12">
                                        <label for="input11" class="form-label">آدرس</label>
