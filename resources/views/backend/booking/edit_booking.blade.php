                ...
                <div class="card radius-10 border-start border-0 border-3 border-info">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div>
                                <p class="mb-0 text-secondary">شماره رزرو</p>
            ...
            <div class="col">
                <div class="card radius-10 border-start border-0 border-3 border-danger">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div>
                                <p class="mb-0 text-secondary">تاریخ رزرو</p>
                                <h6 class="my-1 text-danger">{{ Carbon::parse($editData->created_at)->format('d/m/Y')  }}</h6>
            ...
            <div class="col">
                <div class="card radius-10 border-start border-0 border-3 border-success">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div>
                                <p class="mb-0 text-secondary">پرداخت </p>
            ...
            <div class="col">
                <div class="card radius-10 border-start border-0 border-3 border-warning">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div>
                                <p class="mb-0 text-secondary">وضعبت پرداخت </p>
            ...
            <div class="col">
                <div class="card radius-10 border-start border-0 border-3 border-warning">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div>
                                <p class="mb-0 text-secondary">وضعبت رزرو</p>
                                <h6 class="my-1 text-warning">
                        ...
                        <div class="table-responsive">
                            <table class="table align-middle mb-0">
                                ...
                                <tr>
                                    ...
                                    <td> تومان {{ $editData->actual_price }}</td>
                                    <td>
                            ...
                            <div class="row" style="margin-top: 40px;">
                                <div class="col-md-5">
                                    ...
                                    <select name="payment_status" id="input7" class="form-select">
                                        <option selected="">وضعبت را انتخاب کنید</option>
                                        <option value="0" {{ $editData->payment_status == 0 ? 'selected':''}}> در انتظار پرداخت
                                        </option>
                                        <option value="1" {{ $editData->payment_status == 1?'selected':''}}>پرداخت شده
                                        </option>
                                    </select>
                                </div>
                                ...
                                <div class="col-md-5">
                                    <label for="">وضعبت رزرو</label>
                                    <select name="status" id="input7" class="form-select">
                                        <option selected="">وضعیت را انتخاب کنید</option>
                                        <option value="0" {{ $editData->status == 0 ? 'selected':''}}>در انتظار تایید</option>
                                        <option value="1" {{ $editData->status == 1 ?'selected':''}}>تایید شده</option>
                                    </select>
                                </div>
            ...
            <div class="col-12 col-lg-4">
                <div class="card radius-10 w-100">
                    <div class="card-header">
                        <div class="d-flex align-items-center">
                            <div>
                                <h6 class="mb-0">مدیریت اتاق و تاریخ ها </h6>
                            </div>
                    ...
                    <div class="card-body">
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item d-flex bg-transparent justify-content-between align-items-center border-top">
                                نام<span class="badge bg-success rounded-pill">{{ $editData['user']['name'] }}</span>
                            </li>
                            <li class="list-group-item d-flex bg-transparent justify-content-between align-items-center">
                                ایمیل <span
                                    class="badge bg-danger rounded-pill">{{ $editData['user']['email'] }} </span>
                            </li>
                            <li class="list-group-item d-flex bg-transparent justify-content-between align-items-center">
                                شماره تماس <span
                                    class="badge bg-primary rounded-pill">{{ $editData['user']['phone'] }}</span>
                            </li>
                            <li class="list-group-item d-flex bg-transparent justify-content-between align-items-center">
                                کشور <span
                            ...
                            <li class="list-group-item d-flex bg-transparent justify-content-between align-items-center border-top">
                                استان <span class="badge bg-success rounded-pill">{{ $editData->state }}</span>
                            </li>
                            <li class="list-group-item d-flex bg-transparent justify-content-between align-items-center">
                                کد پستی <span class="badge bg-danger rounded-pill"> {{ $editData->zip_code }} </span>
                            </li>
                            <li class="list-group-item d-flex bg-transparent justify-content-between align-items-center">
                                آدرس <span class="badge bg-danger rounded-pill"> {{ $editData->address }} </span>
                            </li>
