    ...
    <section class="checkout-area pt-100 pb-70">
        <div class="container">
            ...
            <form method="post" role="form" action="{{ route('checkout.store') }}"
                  class="stripe_form require-validation" data-cc-on-file="false"
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="select-box">
                                            <select name="country" class="form-control">
                                                ...
                                                <option value="India">روسیه</option>
                                                <option value="United Arab">امارات متحده عربی</option>
                                                <option value="China">چین</option>
                                                <option value="United Kingdom">انگلستان</option>
                                                <option value="Germany">آلمان</option>
                                                <option value="France">فرانسه</option>
                                                <option value="Japan">ایالات متحده آمریکا</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        @if ($errors->has('state'))
                                            <div class="text-danger">استان خود را بطور صحیح وارد نمایید</div>
                                        @endif
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        @if ($errors->has('zip_code'))
                                            <div class="text-danger">کد پستی خود را بصورت صحیح وارد نمایید</div>
                                        @endif
                                    </div>
                                </div>
                            ...
                            <div class="card-body">
                                <div class="billing-details">
                                    ...
                                    <table class="table" style="width: 100%">
                                        ...
                                        <tr>
                                            <td><p>مجموغ شب ها <br> <b> ( {{ $book_data['check_in'] }}
                                                        - {{ $book_data['check_out'] }})</b></p></td>
                                            <td style="text-align: right"><p> {{ $nights }} روز</p></td>
                                        </tr>
                                        <tr>
                                            <td><p>مجموع اتاق ها</p></td>
                                            <td style="text-align: right"><p>{{ $book_data['number_of_rooms'] }}</p>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><p>جمع کل</p></td>
                                            <td style="text-align: right"><p>تومان{{ $subtotal }}</p></td>
                                        </tr>
                                        <tr>
                                            <td><p>تخفیف</p></td>
                                            <td style="text-align:right"><p>تومان{{ $discount }}</p></td>
                                        </tr>
                                        <tr>
                                            <td><p>جمع نهایی</p></td>
                                            <td style="text-align:right"><p>تومان{{ $subtotal-$discount }}</p></td>
                                        </tr>
                                    </table>
                        ...
                        <div class="payment-box">
                            <div class="payment-method">
                                ...
                                <p>
                                    ...
                                    <label for="cash-on-delivery">نقدی</label>
                                </p>
                            ...
                            <button type="submit" class="order-btn" id="myButton">تایید نهایی</button>
