...
{{--				</a>--}}
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent1">
					<ul class="navbar-nav ms-auto mb-2 mb-lg-0">
						<li class="nav-item"> <a class="nav-link active" aria-current="page" href="#"><i class='bx bx-home-alt me-1'></i>خانه</a>
						</li>
					...
					<div class="row g-0">
						<div class="col col-xl-5">
							<div class="card-body p-4">
								...
								<h2 class="font-weight-bold display-4">صفحه مورد نظر یافت نشد</h2>
								<p>متاسفانه صفحه ای که شما به دنبال جستجوی
									<br>آن هستید در سایت یافت نشد
									<br>لطفا به صفحه قبلی مراجعه نمایید</p>
                                    <div class="mt-5"> <a href="{{route('index-home')}}" class="btn btn-primary btn-lg px-md-5 radius-30">خانه</a>
