...
//     return view('welcome');
// });
Route::get('/', [UserController::class, 'Index'])->name('index-home');
...
Route::controller(TeamController::class)->group(function(){
 ...
 Route::controller(BookingController::class)->group(function(){
    ...
    Route::get('/booking/add', 'AdminBookingCreate')->name('admin.booking.create');
    Route::post('/booking/add', 'AdminBookingStore')->name('admin.booking.store');
    Route::delete('/booking/delete/{booking}', 'AdminBookingDelete')->name('admin.booking.delete');
...
Route::controller(AdminController::class)->group(function(){
 ...
 Route::controller(FrontendRoomController::class)->group(function(){
    ...
    Route::get('/room/details/{id}', 'RoomDetailsPage')->name('RoomDetailsPage');
...
Route::middleware(['auth'])->group(function(){
 ...
 Route::controller(BookingController::class)->group(function(){
    ...
    // Route user add booking
     Route::post('add-booking/{room_id}' , 'addBooking')->name('add_booking');
