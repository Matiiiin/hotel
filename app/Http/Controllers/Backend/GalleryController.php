...
class GalleryController extends Controller
{
    ...
    public function StoreGallery(Request $request){
        ...
        foreach ($images as $img) {
            $name_gen = hexdec(uniqid()) . 'Backend'.'.' .$img->getClientOriginalExtension();
        ...
        $notification = array(
            'message' => 'عکس گالری با موفقیت اضافه شد',
            'alert-type' => 'success'
        );
    ...
    public function UpdateGallery(Request $request){
        ...
        $notification = array(
            'message' => 'عکس گالری با موفقیت بروزرسانی شد',
            'alert-type' => 'success'
        );
    ...
    public function DeleteGallery($id){
        ...
        $notification = array(
            'message' => 'عکس گالری با موفقیت حذف شد',
            'alert-type' => 'success'
        );
